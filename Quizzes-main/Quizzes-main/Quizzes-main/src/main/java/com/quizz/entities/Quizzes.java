...
public class Quizzes implements java.io.Serializable {
    ...
    public Quizzes(Categories categories, Users users, String title, String description, String photo,
	    Integer timeLimit, Integer totalScore, String status, String visibility, Date createdAt, Date updatedAt,
	    Date deletedAt, List<QuizzAttempts> quizzAttemptses, List<Questions> questionses) {
